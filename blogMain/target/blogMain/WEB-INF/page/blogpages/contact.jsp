...
<div class="blog-masthead">
    <div class="container">
        <nav class="blog-nav">
            ...
            <a class="blog-nav-item active" href="${APP_PATH}/contact">Contact</a>
    ...
    <div class="row">
        ...
        <div class="col-sm-8 blog-main" id="blog_post_divs">
            <div class="row blog-post">
                ...
                <p>email: <a href="mailto:zdd1995@mail.ustc.edu.cn">zdd1995<em>@mail.ustc.edu.cn</em></a></p>
                <p>telephone: 183****9653</p>
                <p>QQ: 1005****946</p>
                <p>wechat: i1005****946</p>
                <p>facebook: <a href="https://www.facebook.com/zhangddjs">zdd</a></p>
                <p>twitter: <a href="https://twitter.com/covfefe_zdd">@zdd</a></p>
            </div><!-- /.blog-post -->
        </div><!-- /.blog-main -->
